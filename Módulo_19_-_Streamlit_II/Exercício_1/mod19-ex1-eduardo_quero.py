...
def main():
    ...
    **Data:** 22 de Novembro de 2023.
    ...
    bank_raw = load_data(
        file_data='https://raw.githubusercontent.com/EduardoQuero/Profissao-Cientista-de-Dados/main/Cientista%20de%20Dados/M%C3%B3dulo_19_-_Streamlit_II/Exerc%C3%ADcio_1/data/input/bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
