...
def main():
    ...
    <div style="text-align:center">
        <a href="https://github.com/EduardoQuero/Profissao-Cientista-de-Dados">
            <img src="https://raw.githubusercontent.com/EduardoQuero/Profissao-Cientista-de-Dados/main/Cientista%20de%20Dados/ebac-course-utils/media/logo/ebac_logo-data_science.png" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    **Data:** 22 de Novembro de 2023.
    ...
    st.sidebar.markdown(
        body='<img src="https://github.com/EduardoQuero/Profissao-Cientista-de-Dados/blob/main/Cientista%20de%20Dados/M%C3%B3dulo_19_-_Streamlit_II/Exerc%C3%ADcio_1/img/Bank-Branding.jpg" width=100%>',
        unsafe_allow_html=True,
    )
    ...
    if data_file_1 is not None:
        ...
        bank_raw = load_data(
            # file_data="https://raw.githubusercontent.com/EduardoQuero/Profissao-Cientista-de-Dados/main/Cientista%20de%20Dados/M%C3%B3dulo_19_-_Streamlit_II/Exerc%C3%ADcio_1/data/input/bank-additional-full.csv",
